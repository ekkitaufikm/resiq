...
class User extends CI_Controller {
	...
	{
		$data['row'] = $this->user_m->get();
		$this->template->load( 'admin/template', 'admin/user/role', $data);
	}

	public function tambah_role()
	{
		$data['row'] = $this->user_m->get();
		$this->template->load( 'admin/template', 'admin/user/tambah_role');
	}
	...
	public function add()
	{
		...
		$this->template->load('admin/template', 'admin/user/user_form_add', $data);
    }
